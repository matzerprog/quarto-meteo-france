...
Ce projet, réalisé par BRISSON Thomas, BASSET Maxence, DIAZ Mathys, NASSUR CHEIKH Izdihar et RODRIGUEZ Jason, explore la relation entre le changement climatique et la fréquence ainsi que les conséquences des catastrophes climatiques.

![Description de l'image](5 natural disasters that call for climate action.jpg){alt="Description de l'image" style="display: block; margin: 0 auto; border-radius: 10px;"}
